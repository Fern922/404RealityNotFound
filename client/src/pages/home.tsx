...
const MultimediaCarousel = () => {
  ...
  const slides = [
    { id: 1, title: "AR Artifact Visualization", description: "3D models of museum artifacts", image: "https://drive.google.com/drive/folders/144RYzhe8YBGzDNSsso39WtKLDbfo1l3k" },
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 fade-in">
            ...
            <p className="max-w-3xl mx-auto text-lg text-gray-300">
              Interested in learning more about our Bohol Lens Portal? Contact us for collaboration opportunities.
            </p>
          </div>
