        ...
        return (
          <div className="p-6">
            ...
            <div className="grid gap-4">
              <a
                href="https://docs.google.com/document/d/11yD_eFhWG-TYzCGchZZSLIfjexpJPy5KBSnJppi6drg/edit?usp=sharing"
                target="_blank"
              ...
              <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm">
                  Access the complete source code and development history
                </p>
              </div>

              <a
                href="https://docs.google.com/presentation/d/1QKHmVz5f9My30-B_q1BeqAepMrOkxWBnO6GiUviokDc/edit?slide=id.g1106694f9de_1_19040#slide=id.g1106694f9de_1_19040"
                target="_blank"
                rel="noopener noreferrer"
                className="block border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow"
              >
                ...
                <p className="text-gray-600 text-sm">
                  Slides and materials used for project presentations
                </p>
              </a>
            </div>
          </div>
