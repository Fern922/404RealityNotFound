      ...
      <div className="flip-card" onClick={onClick}>
        <div className="flip-card-inner">
          <div className="flip-card-front">
            ...
            <p className="text-sm font-medium text-ar-blue-600">
              {member.role}
            </p>
            <div className="mt-4">
              <i className="fas fa-mouse-pointer text-ar-blue-400 text-sm"></i>
              <p className="text-xs text-ar-blue-500 mt-1">
                Click to view details
              </p>
            </div>
          </div>
          <div
            className="flip-card-back bg-cover bg-center text-white"
            style={{
              backgroundImage: `url(${member.image})`,
            }}
          >
            <div className="bg-black bg-opacity-50 p-4 h-full w-full flex flex-col items-center justify-center">
